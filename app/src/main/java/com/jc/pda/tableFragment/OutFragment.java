...
import com.jc.pda.adapter.BillOutAdapter;
import com.jc.pda.component.DaggerOutFragmentComponent;
...
import com.jc.pda.presenter.OutFragmentPresenter;
...
public class OutFragment extends Fragment implements OutFragmentView ,BillOutAdapter.OnItemClickListener{

    @BindView(R.id.tbar_out)
    Toolbar tbarOut;
    @BindView(R.id.ctl_out)
    CollapsingToolbarLayout ctlOut;
    @BindView(R.id.abl_out)
    AppBarLayout ablOut;
    @BindView(R.id.tv_out_time)
    TextView tvTime;
    @BindView(R.id.lc_out_table)
    LineChart lcTable;
    @BindView(R.id.tv_out_dealer)
    TextView tvDealer;
    @BindView(R.id.rv_out_bills)
    RecyclerView rvBills;

    Unbinder unbinder;

    private List<Bill> list;
    private BillOutAdapter adapter;

    @Inject
    OutFragmentPresenter presenter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DaggerOutFragmentComponent
                .builder()
                .contextModule(new ContextModule(getActivity()))
                .outFragmentModule(new OutFragmentModule(this))
                .build()
                .inject(this);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //下拉一瞬间颜色
        ctlOut.setContentScrimColor(ContextCompat.getColor(getActivity(), R.color.white));
        ...
        list = new ArrayList<>();
        adapter = new BillOutAdapter(getActivity(), list);
